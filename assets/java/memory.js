...
class GalacticMemoryGame {
    ...
    endGame() {
        ...
        if (this.score > 0) {
            this.container.html('<div class="end-message"><h2>You Won!</h2><br>You totaled: ' + this.score + '/120 points</div><div class="playAgain" id="playAgain' + _this.settings.uniqueId + '">play again</div>');
        } else this.container.html('<div class="end-message"><h2>You Lost!</h2><br><h3>Try Again..</h3></div><div class="playAgain" id="playAgain' + _this.settings.uniqueId + '">play again</div>');
        //restart game
    ...
    createCard(id) {
        ...
        let back = '<div class="back"><div class="title">' + this.deck[id].name + '</div></div>';
        const _this = this;
            ...
            if ($(this).attr('data-playable') == 1 && _this.isStart) {
                ...
                if (_this.actualCard == "") {
                    ...
                    if (_this.actualCard == playedCard) {
                        ...
                        _this.score -= 2;
                        _this.incScore();
                        const actualCard = _this.actualCard;
